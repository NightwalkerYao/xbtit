...
<div class="card-panel transparent">
  <h4 class="no-margin-top"><i class="material-icons left cyan-text" style="font-size: 27pt">vpn_lock</i> Administartion Panel > Site Error Logs</h4>
	<div class="row">
				...
				<td align="center" class="lista">
					...
					<table width="100%" valign="top" id="inputs">
						<form method="POST" action="<tag:frm_action />">
							...
							<tr>
      							<td class="lista" style="text-align:center;" width="50%">
      								<input id="glow" type="text" name="php_log_name" value="<tag:config.php_log_name />" size="50" /><br />
	  								<tag:language.LOGS_COOLY_NAMES />
	  							</td>
      							<td class="lista" style="text-align:center;" width="50%">
      								<input id="glow" type="text" name="php_log_path" value="<tag:config.php_log_path />" size="50" />
						...
						<tr>
	  					...
	  					<tr>
	  						<td class="lista"style="text-align:center;">
	  							<loop:list><tag:list[].file /></loop:list>
	  						</td>
	  					</tr>
	  					<tr>
