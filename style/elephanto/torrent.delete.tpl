<div class="card-panel transparent">
  <h4 class="no-margin-top bg-like-head"><i class="material-icons left cyan-text" style="font-size: 27pt;">delete</i>Supprimer ce Torrent?</h4>
  <br>
...
<form action="index.php?page=delete&amp;info_hash=<tag:torrent.info_hash />&amp;returnto=<tag:torrent.return />" name="delete" method="post">
  <div align="center">
  <input type="submit" class="btn red" name="action" value="<tag:language.FRM_DELETE />" />&nbsp;&nbsp;
