...
$language['PHP_ERROR']='Suppress PHP errors';
...
$language['SETTING_SHOW_COMMENTS']='Show Comments';
$language['SETTING_SHOW_RATING']='Show Rating';
$language['TORRENT_LIST']='Torrent list settings';
